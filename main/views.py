...
class BlogView(ListView):
    ...
    def get(self, request, **args):
        ...
        return render(request, self.template_name, {"blogs": paginated_products, "query": query})
...
class ContactView(View):
    ...
    def get(self, request):
        form = ContactForm()
        help = ContactUS.objects.latest('id')
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            send_mail(
                ...
                message='Мы получили ваше сообщение и ответим в ближайщее время',
